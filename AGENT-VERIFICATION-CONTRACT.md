...
- A material/hardware subtotal may be shown separately. Under the Travel Standard, Q must remain null until complete.
...
- status must remain incomplete when required machine time or processing dollars are unresolved.
